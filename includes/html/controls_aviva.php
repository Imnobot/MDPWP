...
$markup .= '<div class="mvp-player-controls">
    ...
    <div class="mvp-player-controls-top">';
        ...
        if($options["usePlaylistToggle"])$markup .= '<div class="mvp-playlist-toggle mvp-contr-btn" data-tooltip="'.esc_attr($options["tooltipPlaylistToggle"]).'" data-tooltip-position="left">
        ...
        if($options["useInfo"])$markup .= '<div class="mvp-info-toggle mvp-contr-btn" data-tooltip="'.esc_attr($options["tooltipInfo"]).'" data-tooltip-position="left">
            <svg aria-hidden="true" focusable="false" role="img" viewBox="0 0 512 512"><path d="M256 8C119.043 8 8 119.083 8 256c0 136.997 111.043 248 248 248s248-111.003 248-248C504 119.083 392.957 8 256 8zm0 110c23.196 0 42 18.804 42 42s-18.804 42-42 42-42-18.804-42-42 18.804-42 42-42zm56 254c0 6.627-5.373 12-12 12h-88c-6.627 0-12-5.373-12-12v-24c0-6.627 5.373-12 12-12h12v-64h-12c-6.627 0-12-5.373-12-12v-24c0-6.627 5.373-12 12-12h64c6.627 0 12 5.373 12 12v100h12c6.627 0 12 5.373 12 12v24z"></path></svg>
        </div>';

        if($options["useShare"])$markup .= '<div class="mvp-share-toggle mvp-contr-btn" data-tooltip="'.esc_attr($options["tooltipShare"]).'" data-tooltip-position="left">
        ...
        if($options["useEmbed"])$markup .= '<div class="mvp-embed-toggle mvp-contr-btn" data-tooltip="'.esc_attr($options["tooltipEmbed"]).'" data-tooltip-position="left">
        ...
        if($options["useDownload"])$markup .= '<div class="mvp-download-toggle mvp-contr-btn" data-tooltip="'.esc_attr($options["tooltipDownload"]).'" data-tooltip-position="left"><a href="#">
        ...
        if($options["usePip"])$markup .= '<div class="mvp-pip-toggle mvp-contr-btn" data-tooltip="'.esc_attr($options["tooltipPip"]).'" data-tooltip-position="left">
    ...
    $markup .= '</div><!-- end mvp-player-controls-top -->

</div><!-- end mvp-player-controls -->';
...
$markup .= '<div class="mvp-player-controls">
    ...
    <div class="mvp-player-controls-bottom">
        ...
        <div class="mvp-player-controls-bottom-left">';
            ...
            if($options["usePrevious"])$markup .= '<div class="mvp-previous-toggle mvp-contr-btn" data-tooltip="'.esc_attr($options['tooltipPrevious']).'">
                <svg aria-hidden="true" focusable="false" role="img" viewBox="0 0 448 512"><path d="M64 468V44c0-6.6 5.4-12 12-12h48c6.6 0 12 5.4 12 12v176.4l195.5-181C352.1 22.3 384 36.6 384 64v384c0 27.4-31.9 41.7-52.5 24.6L136 292.7V468c0 6.6-5.4 12-12 12H76c-6.6 0-12-5.4-12-12z"></path></svg>
            </div>';
            ...
            if($options["useNext"])$markup .= '<div class="mvp-next-toggle mvp-contr-btn" data-tooltip="'.esc_attr($options['tooltipNext']).'">
        ...
        $markup .= '<div class="mvp-player-controls-bottom-right">';
            ...
            if($options["useTheaterMode"])$markup .= '<div class="mvp-theater-toggle mvp-contr-btn" data-tooltip="'.esc_attr($options["tooltipTheaterMode"]).'">
                <svg aria-hidden="true" focusable="false" role="img" viewBox="0 0 459 459"><path d="M408,51H51C22.95,51,0,73.95,0,102v255c0,28.05,22.95,51,51,51h357c28.05,0,51-22.95,51-51V102 C459,73.95,436.05,51,408,51z M408,357H51V102h357V357z"/></svg>
            </div>';
...
if($options["useVideoTransform"]){
    ...
    $markup .= '<div class="mvp-transform-controls">
        ...
        <div class="mvp-transform-control-inner">
            ...
            <div class="mvp-transform-move-left mvp-contr-btn" data-tooltip="'.esc_attr($options["tooltipMoveLeft"]).'"><svg aria-hidden="true" focusable="false" role="img" viewBox="0 0 444.531 444.531"><<path d="M34.52 239.03L228.87 44.69c9.37-9.37 24.57-9.37 33.94 0l22.67 22.67c9.36 9.36 9.37 24.52.04 33.9L131.49 256l154.02 154.75c9.34 9.38 9.32 24.54-.04 33.9l-22.67 22.67c-9.37 9.37-24.57 9.37-33.94 0L34.52 272.97c-9.37-9.37-9.37-24.57 0-33.94z"/></svg></div>

            <div class="mvp-transform-move-right mvp-contr-btn" data-tooltip="'.esc_attr($options["tooltipMoveRight"]).'"><svg aria-hidden="true" focusable="false" role="img" viewBox="0 0 444.819 444.819"><path d="M285.476 272.971L91.132 467.314c-9.373 9.373-24.569 9.373-33.941 0l-22.667-22.667c-9.357-9.357-9.375-24.522-.04-33.901L188.505 256 34.484 101.255c-9.335-9.379-9.317-24.544.04-33.901l22.667-22.667c9.373-9.373 24.569-9.373 33.941 0L285.475 239.03c9.373 9.372 9.373 24.568.001 33.941z"/></svg></div>
            ...
            <div class="mvp-transform-zoom-in mvp-contr-btn" data-tooltip="'.esc_attr($options["tooltipZoomIn"]).'"><svg aria-hidden="true" focusable="false" role="img" viewBox="0 0 448 512"><path d="M416 208H272V64c0-17.67-14.33-32-32-32h-32c-17.67 0-32 14.33-32 32v144H32c-17.67 0-32 14.33-32 32v32c0 17.67 14.33 32 32 32h144v144c0 17.67 14.33 32 32 32h32c17.67 0 32-14.33 32-32V304h144c17.67 0 32-14.33 32-32v-32c0-17.67-14.33-32-32-32z"/></svg></div>

            <div class="mvp-transform-zoom-out mvp-contr-btn" data-tooltip="'.esc_attr($options["tooltipZoomOut"]).'"><svg aria-hidden="true" focusable="false" role="img" viewBox="0 0 448 512"><path d="M416 208H32c-17.67 0-32 14.33-32 32v32c0 17.67 14.33 32 32 32h384c17.67 0 32-14.33 32-32v-32c0-17.67-14.33-32-32-32z"/></svg></div>

            <div class="mvp-transform-rotate-left mvp-contr-btn" data-tooltip="'.esc_attr($options["tooltipRotateLeft"]).'"><svg aria-hidden="true" focusable="false" role="img" viewBox="0 0 512 512"><path d="M480 256c0 123.4-100.5 223.9-223.9 223.9c-48.84 0-95.17-15.58-134.2-44.86c-14.12-10.59-16.97-30.66-6.375-44.81c10.59-14.12 30.62-16.94 44.81-6.375c27.84 20.91 61 31.94 95.88 31.94C344.3 415.8 416 344.1 416 256s-71.69-159.8-159.8-159.8c-37.46 0-73.09 13.49-101.3 36.64l45.12 45.14c17.01 17.02 4.955 46.1-19.1 46.1H35.17C24.58 224.1 16 215.5 16 204.9V59.04c0-24.04 29.07-36.08 46.07-19.07l47.6 47.63C149.9 52.71 201.5 32.11 256.1 32.11C379.5 32.11 480 132.6 480 256z"/></svg></div>

            <div class="mvp-transform-rotate-right mvp-contr-btn" data-tooltip="'.esc_attr($options["tooltipRotateRight"]).'"><svg aria-hidden="true" focusable="false" role="img" viewBox="0 0 512 512"><path d="M468.9 32.11c13.87 0 27.18 10.77 27.18 27.04v145.9c0 10.59-8.584 19.17-19.17 19.17h-145.7c-16.28 0-27.06-13.32-27.06-27.2c0-6.634 2.461-13.4 7.96-18.9l45.12-45.14c-28.22-23.14-63.85-36.64-101.3-36.64c-88.09 0-159.8 71.69-159.8 159.8S167.8 415.9 255.9 415.9c73.14 0 89.44-38.31 115.1-38.31c18.48 0 31.97 15.04 31.97 31.96c0 35.04-81.59 70.41-147 70.41c-123.4 0-223.9-100.5-223.9-223.9S132.6 32.44 256 32.44c54.6 0 106.2 20.39 146.4 55.26l47.6-47.63C455.5 34.57 462.3 32.11 468.9 32.11z"/></svg></div>
