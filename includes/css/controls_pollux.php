<?php 
	...
	#".$wrapper_id." .mvp-next-toggle{
	    background: ".$options['playbackControlsBgColor']."!important;
	}
	
	@media (hover: hover) {
	#".$wrapper_id." .mvp-player-controls-top .mvp-contr-btn:hover{
		background: ".$options['topRightControlsBgHoverColor']."!important;
	}
	}
	...
	#".$wrapper_id." .mvp-input-progress::-webkit-slider-thumb {
	    background: ".$options['seekbarProgressPointerColor'].";
	}
	#".$wrapper_id." .mvp-input-progress::-moz-range-thumb {
	    background: ".$options['seekbarProgressPointerColor'].";
	}
	#".$wrapper_id." .mvp-input-volume::-webkit-slider-thumb {
	    background:".$options['volumeLevelPointerColor'].";
	}
	#".$wrapper_id." .mvp-input-volume::-moz-range-thumb {
	    background:".$options['volumeLevelPointerColor'].";
	}
