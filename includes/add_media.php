<div>
	...
	<form id="mvp-edit-media-form" method="post" action="">
        ...
        <p class="mvp-modal-actions">     
            ...
            <button type="button" id="mvp-edit-media-form-submit" class="button-primary mvp-edit-playlist-mode" type="button" <?php disabled( !current_user_can(MVP_CAPABILITY) ); ?>><?php esc_html_e('Save changes', MVP_TEXTDOMAIN); ?></button> 
        </p>
